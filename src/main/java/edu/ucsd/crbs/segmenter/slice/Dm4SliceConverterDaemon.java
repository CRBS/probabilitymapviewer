...
public class Dm4SliceConverterDaemon implements SliceConverterDaemon {
    ...
    /**
     * Adjusts time this object sleeps when no data needs to be converted
     * in {@link #run()} method. If value less then 0 is passed in method
     * will use value of 0.
    ...
    /**
     * Converts second youngest {@link Dm4SliceFile#DM4_EXTENSION} 
     * file found in input directory
     * via {@link SliceConverter} set in constructor writing output to
     * directory under {@link #getDestinationDirectory()}  
     * 
     * Should be run under a new thread.  This method loops indefinitely
     * until {@link #shutdown()} is invoked.  
     */
    @Override
    public void run() {        
     ...
     */
    public File getSecondYoungestDm4File(){
