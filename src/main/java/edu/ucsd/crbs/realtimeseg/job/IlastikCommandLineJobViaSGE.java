 ...
 */
public class IlastikCommandLineJobViaSGE implements Callable {

     private static final Logger _log = Logger.getLogger(IlastikCommandLineJobViaSGE.class.getName());
    ...
    public IlastikCommandLineJobViaSGE(final String script,final String inputImageName,
    ...
    public Object call() throws Exception {
        ...
        String result = null;
        _log.log(Level.INFO, "Running Ilastik on {0}",_inputImageName);
        JobResult jobResult = new JobResult();
        
        try {
            String fixedName = "ilastik_"+_inputImageName.replaceAll("-", "");
            ...
            jobResult.setRunTimeInMilliseconds(chmDuration);
             _log.log(Level.INFO,"{0} Ilastik & Convert Took: {1} seconds",
