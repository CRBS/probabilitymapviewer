 ...
 */
public class CustomLayerFromCCDBFactory {
    
    private Properties _props;
    public CustomLayerFromCCDBFactory(Properties props){
        _props = props;
    }
    
    public CustomLayer getCustomLayer(final String id,
            final String trainedModelDir,
            final String color){
        
        return new CustomLayer(trainedModelDir,id,color,"chm");
    }
